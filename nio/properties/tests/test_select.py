...
class TestProperties(NIOTestCaseNoModules):
    ...
    def test_deserialize(self):
        ...
        prop = SelectProperty("prop", SampleEnum, default=SampleEnum.option1)
        self.assertEqual(prop.deserialize(prop.default), SampleEnum.option1)
        prop = SelectProperty("prop", SampleEnum, default='option1')
        self.assertEqual(prop.deserialize(prop.default), SampleEnum.option1)
        prop = SelectProperty("prop", SampleEnum, default=0)
        self.assertEqual(prop.deserialize(prop.default), SampleEnum.option1)
        prop = SelectProperty("prop", SampleEnum,
